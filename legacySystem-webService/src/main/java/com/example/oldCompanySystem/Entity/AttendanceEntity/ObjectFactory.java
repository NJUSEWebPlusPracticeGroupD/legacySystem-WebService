 ...
 * generated in the AttendanceEntity package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetGroupScheduleParam_QNAME = new QName("http://www.oldCompany.com/attendance", "getGroupScheduleParam");
    private final static QName _GetAllShiftsParam_QNAME = new QName("http://www.oldCompany.com/attendance", "getAllShiftsParam");
    private final static QName _GetAllGroupScheduleParam_QNAME = new QName("http://www.oldCompany.com/attendance", "getAllGroupScheduleParam");
    private final static QName _GetOrderByIdParam_QNAME = new QName("http://www.oldCompany.com/order", "getOrderByIdParam");
    private final static QName _GroupSchedulingInformation_QNAME = new QName("http://www.oldCompany.com/attendance", "GroupSchedulingInformation");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: AttendanceEntity
     * 
     */
    ...
    /**
     * Create an instance of {@link GroupScheduleInformationType }
     * 
     */
    public GroupScheduleInformationType createGroupScheduleInformationType() {
        return new GroupScheduleInformationType();
    }

    /**
     * Create an instance of {@link GetGroupScheduleInformationParamType }
     * 
     */
    public GetGroupScheduleInformationParamType createGetGroupScheduleInformationParamType() {
        return new GetGroupScheduleInformationParamType();
    }

    /**
     * Create an instance of {@link GroupScheduleInformationList }
     * 
     */
    public GroupScheduleInformationList createGroupScheduleInformationList() {
        return new GroupScheduleInformationList();
    }
    ...
    /**
     * Create an instance of {@link ShiftTimeType }
     * 
     */
    public ShiftTimeType createShiftTimeType() {
        return new ShiftTimeType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetGroupScheduleInformationParamType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.oldCompany.com/attendance", name = "getGroupScheduleParam")
    public JAXBElement<GetGroupScheduleInformationParamType> createGetGroupScheduleParam(GetGroupScheduleInformationParamType value) {
        return new JAXBElement<GetGroupScheduleInformationParamType>(_GetGroupScheduleParam_QNAME, GetGroupScheduleInformationParamType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.oldCompany.com/attendance", name = "getAllShiftsParam")
    public JAXBElement<String> createGetAllShiftsParam(String value) {
        return new JAXBElement<String>(_GetAllShiftsParam_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.oldCompany.com/attendance", name = "getAllGroupScheduleParam")
    public JAXBElement<String> createGetAllGroupScheduleParam(String value) {
        return new JAXBElement<String>(_GetAllGroupScheduleParam_QNAME, String.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GroupScheduleInformationType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.oldCompany.com/attendance", name = "GroupSchedulingInformation")
    public JAXBElement<GroupScheduleInformationType> createGroupSchedulingInformation(GroupScheduleInformationType value) {
        return new JAXBElement<GroupScheduleInformationType>(_GroupSchedulingInformation_QNAME, GroupScheduleInformationType.class, null, value);
    }
